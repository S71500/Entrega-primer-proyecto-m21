document.addEventListener("DOMContentLoaded", () => {
  ...
  const buyButton = cartContainer
    ? cartContainer.querySelector(".order-btn")
    : null;
  ...
  function updateCartBadge() {
    if (!cartContainer || !cartBadge) return;
  ...
  addCartButtons.forEach((btn) => {
    btn.addEventListener("click", (e) => {
      ...
      if (!product || !cartContainer || !buyButton) return;
